/obj/machinery/box_vendor
	...
	var/list/vendoptions = list("Dispense standard Container", "Dispense difficult advanced electronics Container", "Dispense difficult advanced military Container", "Dispense difficult advanced xen Container")
...
/obj/machinery/box_vendor/interact(mob/living/carbon/human/user)
	...
	switch(dispensation)
		...
		if("Dispense difficult advanced xen Container")
			playsound(src, 'hl13/sound/machines/combine_button3.ogg', 50, TRUE, extrarange = -3)
			...
			new /obj/item/factory_construction/container/advanced/xen(loc)
