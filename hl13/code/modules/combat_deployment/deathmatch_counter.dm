/obj/machinery/deathmatch_counter
	...
	var/combine_points_win = 21 //rebels have less survivability overall, so combine need one extra kill to make it a tiny bit more fair

	/// How many combine deaths needed for rebels to win
	var/rebel_points_win = 20
