...
/obj/item/hl2/loadout_picker/xen/tier6/additional_effects(mob/living/user)
	for(var/X in GLOB.deployment_rebel_players)
		...
		to_chat(H, "<span class='userdanger big'>A terrifying presence has been spotted in the district... Two Tier 5 Loadout spawners have been made available in your team's cash deposit for anyone to upgrade from.</span>")
	...
	for(var/X in GLOB.deployment_xen_players)
		...
		GLOB.deployment_rebels_free_tier5s += 2
		GLOB.deployment_combine_free_tier5s += 2
