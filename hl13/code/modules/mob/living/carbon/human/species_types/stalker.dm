/datum/species/stalker
	...
	inherent_traits = list(TRAIT_NOGUNS, TRAIT_RESISTCOLD, TRAIT_RESISTHIGHPRESSURE,TRAIT_RESISTLOWPRESSURE,
							...
							TRAIT_NOCRITDAMAGE, TRAIT_GENELESS, TRAIT_NOSOFTCRIT, TRAIT_NOHARDCRIT, TRAIT_ANALGESIA, TRAIT_NO_UNDERWEAR, TRAIT_GRABWEAKNESS, TRAIT_AGEUSIA, TRAIT_STRONG_STOMACH, TRAIT_NOSLEEP)
...
/datum/species/stalker/on_species_gain(mob/living/carbon/human/C, datum/species/old_species)
	...
	C.change_stat(STATKEY_STR, -7)
	C.change_stat(STATKEY_END, -7)
