...
/datum/trader_data/halflife/smuggler
	...
	initial_products = list(
		...
		/obj/item/storage/belt/civilprotection = list(PAYCHECK_CREW * 3, 3),
...
/datum/trader_data/halflife/crabwalker
	...
	initial_wanteds = list(
		...
		/obj/item/food/meat/steak/plain/human = list(PAYCHECK_CREW, 10, ""),
		/obj/item/food/meat/slab/human = list(PAYCHECK_CREW, 10, ""),
...
/datum/trader_data/halflife/blackmarket
	...
	initial_products = list(
		...
		/obj/item/reagent_containers/hypospray/medipen/healthpen/chopchop = list(PAYCHECK_CREW * 3, 5),
	)
	...
	initial_wanteds = list(
		...
		/obj/item/gun/ballistic/automatic/pistol/usp = list(PAYCHECK_CREW * 5, 3, ""),
...
/datum/trader_data/halflife/refugee_tradesmen
	...
	initial_products = list(
		...
		/obj/item/storage/belt/civilprotection = list(PAYCHECK_CREW * 2, 3),
		...
		/obj/item/reagent_containers/cup/glass/canteen = list(PAYCHECK_CREW * 2, 5),
	...
	initial_wanteds = list(
		/obj/item/factory_construction/full_container/standard = list(PAYCHECK_CREW * 1.75, 15, ""),
		...
		/obj/item/cigarette/halflife = list(PAYCHECK_CREW * 0.25, 15, ""),
		/obj/item/reagent_containers/pill/patch/grubnugget = list(PAYCHECK_CREW * 0.25, 15, ""),
		/obj/item/reagent_containers/pill/patch/medkit = list(PAYCHECK_CREW * 1.5, 15, ""),
		/obj/item/circuitmaterial = list(PAYCHECK_CREW * 0.25, 10, ""),
