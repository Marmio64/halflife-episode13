...
/datum/trader_data/halflife/smuggler
	...
	initial_products = list(
		...
		/obj/item/weaponcrafting/frame/usp = list(PAYCHECK_CREW * 6, 2),
		...
		/obj/item/clothing/suit/armor/civilprotection = list(PAYCHECK_CREW * 7, 3),
		/obj/item/clothing/head/helmet/halflife/military/weak/crafted = list(PAYCHECK_CREW * 3, 5),
