...
/mob/living/basic/citizen/Initialize(mapload)
	...
	AddElement(/datum/element/ai_swap_combat_mode, BB_BASIC_MOB_CURRENT_TARGET, battle_start_barks = list("HEEELP!!", "Taste the pain!", "Leave me alone!"), battle_end_barks = list("I think I'm hurt...",))
	if(LAZYLEN(loot))
