...
/obj/item/clothing/under/combine/proc/administer_stimulant()
	...
	if(suit_power > 25)
		...
		owner.reagents.add_reagent(/datum/reagent/medicine/concentrated_biogel/slurry/suit_slurry, 3)
	else
...
/obj/item/clothing/under/combine/grunt/fused/victim
	slowdown = -0.5
...
/obj/item/clothing/under/citizen/refugee/green/slowing
	slowdown = 3
...
/obj/item/clothing/under/halflife/conscript/bdu
	name = "\improper BDU"
	desc = "A Battle Dress Uniform used by Gurlukovich Mercenaries. I'm Metal Gearing it."
