...
/obj/item/clothing/mask/gas/civilprotection
	...
	var/static/list/cp_voicelines = list(
		...
		"You can go" = 'hl13/sound/voice/cpvoicelines/allrightyoucango.ogg',
		...
		"I said pick it up" = 'hl13/sound/voice/cpvoicelines/pickupthecan3.ogg',
		"Receive civil judgement" = 'hl13/sound/voice/cpvoicelines/prepareforjudgement.ogg',
		...
		"Roger" = 'hl13/sound/voice/cpvoicelines/rodgerthat.ogg',
		...
		"We have no containment" = 'hl13/sound/voice/cpvoicelines/cpisoverrunwehavenocontainment.ogg',
		...
		"Low on ammo" = 'hl13/sound/voice/cpvoicelines/runninglowonverdicts.ogg',
...
/obj/item/clothing/mask/gas/civilprotection/divisional/elitebeta/allowheadwear
	no_headwear = FALSE
