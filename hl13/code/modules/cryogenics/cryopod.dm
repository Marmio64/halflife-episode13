...
/obj/machinery/computer/cryopod
	...
	desc = "An interface between ciitzens and the cryogenic storage oversight systems."
	icon = 'hl13/icons/obj/machines/cryogenics.dmi'
...
/obj/machinery/cryopod/proc/despawn_occupant()
	...
	//GLOB.manifest.modify(mob_occupant.real_name, computer_id_slot.assignment, computer_id_slot.get_trim_assignment())
	...
	if(GLOB.announcement_systems.len)
		...
		announcer.announce("CRYOSTORAGE", mob_occupant.real_name, mob_occupant.job, list())
...
/obj/machinery/cryopod/mouse_drop_receive(mob/living/target, mob/user)
