/obj/item/paper/fluff/jobs/science/construction
	name = "paper- 'Scanner and Viscerator Construction'"
	default_raw_text = "Remember, keep your tools on the electronics bench for construction, so everything stays organized. I don't know what happened to all the circuit pieces, we may have to get some citizens to scrap some together from the trash."
