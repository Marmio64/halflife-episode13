...
/obj/item/climbing_hook/syndicate
	...
	desc = "REALLY suspicious climbing hook to scale up holes. The hook has a lambda logo engraved on it, and the rope has mechanical mechanisms to assist with climbing away from nefarious activities."
