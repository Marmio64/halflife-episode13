...
GLOBAL_LIST_INIT(glass_recipes, list ( \
	...
	new/datum/stack_recipe("fulltile directional window", /obj/structure/window/fulltile/halflife/nosmooth/generic, 2, time =  1 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ON_SOLID_GROUND | CRAFT_IS_FULLTILE, category = CAT_WINDOWS), \
