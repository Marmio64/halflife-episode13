GLOBAL_LIST_INIT(rod_recipes, list ( \
	...
	new/datum/stack_recipe("table frame", /obj/structure/table_frame/halflife, 2, time = 1 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_FURNITURE), \
