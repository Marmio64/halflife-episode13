...
/turf
	...
	var/bullet_bounce_sound = 'hl13/sound/effects/bulletcasing_fall1.ogg' //sound played when a shell casing is ejected ontop of the turf.
 ...
 *
 * Arguments:
 * * clicker: The movable, if one exists, being used for mobility checks to see what tiles it can reach
...
*/
/turf/proc/reachableAdjacentTurfs(atom/movable/clicker, list/access, simulated_only, no_id = FALSE)
	var/static/space_type_cache = typecacheof(/turf/open/space)
	. = list()

	var/datum/can_pass_info/pass_info = new(clicker, access, no_id)
