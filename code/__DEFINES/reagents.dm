...
#define WITHDRAWAL_STAGE1_START_CYCLE 81 //HL13 EDITS, TO MAKE WITHDRAWLS TAKE SLIGHTLY LONGER
#define WITHDRAWAL_STAGE1_END_CYCLE 140
#define WITHDRAWAL_STAGE2_START_CYCLE 141
