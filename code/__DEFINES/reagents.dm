...
#define WITHDRAWAL_STAGE1_START_CYCLE 221 //HL13 EDITS, TO MAKE WITHDRAWLS TAKE SLIGHTLY LONGER
#define WITHDRAWAL_STAGE1_END_CYCLE 280
#define WITHDRAWAL_STAGE2_START_CYCLE 281
#define WITHDRAWAL_STAGE2_END_CYCLE 340
#define WITHDRAWAL_STAGE3_START_CYCLE 341
