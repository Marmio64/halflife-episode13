...
#define WITHDRAWAL_STAGE1_START_CYCLE 241 //HL13 EDITS, TO MAKE WITHDRAWLS TAKE SLIGHTLY LONGER
#define WITHDRAWAL_STAGE1_END_CYCLE 300
#define WITHDRAWAL_STAGE2_START_CYCLE 301
#define WITHDRAWAL_STAGE2_END_CYCLE 360
#define WITHDRAWAL_STAGE3_START_CYCLE 361
