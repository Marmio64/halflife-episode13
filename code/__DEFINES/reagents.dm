...
#define WITHDRAWAL_STAGE1_START_CYCLE 101 //HL13 EDITS, TO MAKE WITHDRAWLS TAKE SLIGHTLY LONGER
#define WITHDRAWAL_STAGE1_END_CYCLE 160
#define WITHDRAWAL_STAGE2_START_CYCLE 161
#define WITHDRAWAL_STAGE2_END_CYCLE 220
#define WITHDRAWAL_STAGE3_START_CYCLE 221
