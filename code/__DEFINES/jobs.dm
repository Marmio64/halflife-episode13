...
#define JOB_OUTLANDS_LIEUTENANT "Polish Liberation Front Lieutenant"
#define JOB_OUTLANDS_QUARTERMASTER "Polish Free State Quartermaster"
#define JOB_OUTLANDS_SERGEANT "Polish Liberation Front Sergeant"
#define JOB_OUTLANDS_SOLDIER "Polish Liberation Front Private"
#define JOB_OUTLANDS_POLICE "Polish Free State Civil Police"
...
/// This job is only active in city RP mode
#define JOB_CITY_JOB (1<<16)
...
#define STATION_JOB_FLAGS (JOB_ANNOUNCE_ARRIVAL|JOB_CREW_MANIFEST|JOB_EQUIP_RANK|JOB_CREW_MEMBER|JOB_NEW_PLAYER_JOINABLE|JOB_REOPEN_ON_ROUNDSTART_LOSS|JOB_ASSIGN_QUIRKS|JOB_PRISON_JOB|JOB_CITY_JOB)
