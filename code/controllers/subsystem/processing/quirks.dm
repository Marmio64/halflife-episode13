...
GLOBAL_LIST_INIT_TYPED(quirk_blacklist, /list/datum/quirk, list(
	...
	list(/datum/quirk/numb, /datum/quirk/masochist), //hl13 edit
	...
	list(/datum/quirk/intelligent, /datum/quirk/unintelligent, /datum/quirk/genius, /datum/quirk/clumsy), //hl13 edit
