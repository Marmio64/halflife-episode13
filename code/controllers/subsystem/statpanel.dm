...
#endif
	var/static/list/beta_notice = list("", "You are on 516, but the server is not yet fully updated to 516, and some UI problems may occur!", "Please report issues, and switch back to BYOND 515 if things are causing too many issues for you.")
