/obj/machinery/vending/boozeomat
	...
	desc = "A vending machine set up by the combine to dispense only approved ethanol beverages, in order to keep citizens compliant. May or may not have had other drinks added to it without prior authorization."
	...
	default_price = PAYCHECK_CREW * 1.15
