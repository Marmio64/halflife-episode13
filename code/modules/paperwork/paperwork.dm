...
/obj/item/paperwork/research/Initialize(mapload)
	...
	detailed_desc += span_info(" The documents detail the results of a standard ordnance test that occured at a nearby research center.")
	...
	detailed_desc += span_info(" If your math is correct, this explosion didn't happen at the center's ordnance site, it occured in the center's engine room.")
