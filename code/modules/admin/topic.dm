...
/datum/admins/Topic(href, href_list)
	...
	//hl13 edit start
		...
		else if(points_to_give < 0)
			to_chat(rankpoints_recepient, span_warning("You have been deducted [points_to_give] rank points for this character. This may not show up until next time you spawn in."))
