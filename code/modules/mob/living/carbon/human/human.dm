...
/mob/living/carbon/human/updatehealth()
	...
	if(health_deficiency >= 50) //HL13 EDIT
		add_or_update_variable_movespeed_modifier(/datum/movespeed_modifier/damage_slowdown, TRUE, multiplicative_slowdown = health_deficiency / 85) //HL13 EDIT
