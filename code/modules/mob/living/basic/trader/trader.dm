...
/mob/living/basic/trader/Initialize(mapload)
	...
	AddComponent(/datum/component/ranged_attacks, casing_type = ranged_attack_casing, projectile_sound = ranged_attack_sound, cooldown_time = 1.5 SECONDS) //hl13 edit, lower attack cooldown
