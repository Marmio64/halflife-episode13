/datum/job/security_officer
	...
	description = "Follow the orders of the Divisional Lead and the District Administrator, and ensure the citizenry do their jobs without getting rebellious thoughts."
