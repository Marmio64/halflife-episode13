...
/obj/item/seeds/ambrosia
	...
	reagents_add = list(/datum/reagent/medicine/c2/aiuri = 0.1, /datum/reagent/medicine/c2/libital = 0.1 ,/datum/reagent/drug/space_drugs = 0.15, /datum/reagent/consumable/nutriment/vitamin = 0.02, /datum/reagent/consumable/nutriment = 0.05, /datum/reagent/toxin = 0.15)
	weed_chance = 10
...
/obj/item/seeds/ambrosia/deus
	...
	reagents_add = list(/datum/reagent/medicine/omnizine = 0.1, /datum/reagent/medicine/synaptizine = 0.15, /datum/reagent/drug/space_drugs = 0.1, /datum/reagent/consumable/nutriment/vitamin = 0.02, /datum/reagent/consumable/nutriment = 0.05)
	rarity = 40
...
/obj/item/seeds/ambrosia/gaia
	...
	mutatelist = list(/obj/item/seeds/ambrosia/deus)
	reagents_add = list(/datum/reagent/medicine/earthsblood = 0.02, /datum/reagent/consumable/nutriment = 0.04, /datum/reagent/consumable/nutriment/vitamin = 0.04)
