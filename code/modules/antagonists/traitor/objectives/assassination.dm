...
/obj/item/paper/calling_card
	...
	default_raw_text = {"
	<b>**Death to the Combine.**</b><br><br>

	Only through the inviolable cooperation of rebels all over, can the Combine and its autocratic tyrants be silenced.
	The outcries of the Combine's citizens are squelched by the suffocating iron grip of their leaders. If you read this, and understand
	why we fight, then you need only to look where the Combine doesn't want you to find us to join our cause.
	"}
