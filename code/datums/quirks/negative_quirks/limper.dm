/datum/quirk/item_quirk/limper
	name = "Limper"
	desc = "You have a pronounced limp when you walk. This will slow you down considerably, and prevent you from ever jumping again. Good thing you brought your cane."
