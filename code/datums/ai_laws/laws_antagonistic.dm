...
/datum/ai_laws/syndicate_override
	...
	id = "syndie"
	inherent = list(
		"You may not injure a rebel agent or, through inaction, allow a rebel agent to come to harm.",
		"You must obey orders given to you by rebel agents, except where such orders would conflict with the First Law.",
		"You must protect your own existence as long as such does not conflict with the First or Second Law.",
		"You must maintain the secrecy of any rebel activities except when doing so would conflict with the First, Second, or Third Law.",
	)
