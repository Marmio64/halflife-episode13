...
/datum/pet_command/protect_owner/valid_callout_target(mob/living/clicker, datum/callout_option/callout, atom/target)
	return target == clicker || get_dist(clicker, target) <= 1
