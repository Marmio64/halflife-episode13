...
DEFINE_BITFIELD(weapon_category, list(
	"WEAPON_CAT_LIGHT" = WEAPON_CAT_LIGHT,
	"WEAPON_CAT_SMG" = WEAPON_CAT_SMG,
	"WEAPON_CAT_RIFLE" = WEAPON_CAT_RIFLE,
	"WEAPON_CAT_SHOTGUN" = WEAPON_CAT_SHOTGUN,
	"WEAPON_CAT_MARKSMEN" = WEAPON_CAT_MARKSMEN,
	"WEAPON_CAT_HEAVY" = WEAPON_CAT_HEAVY,
	"WEAPON_CAT_SPECIALTY" = WEAPON_CAT_SPECIALTY,
	"WEAPON_CAT_REVOLVER" = WEAPON_CAT_REVOLVER,
	"WEAPON_CAT_ALL" = WEAPON_CAT_ALL,
	"WEAPON_CAT_NONE" = WEAPON_CAT_NONE,
))

DEFINE_BITFIELD(weapon_specialties, list(
	"WEAPON_CAT_LIGHT" = WEAPON_CAT_LIGHT,
	"WEAPON_CAT_SMG" = WEAPON_CAT_SMG,
	"WEAPON_CAT_RIFLE" = WEAPON_CAT_RIFLE,
	"WEAPON_CAT_SHOTGUN" = WEAPON_CAT_SHOTGUN,
