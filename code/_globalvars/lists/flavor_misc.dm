...
GLOBAL_LIST_INIT(rebel_loadout_prefs, sort_list(list(
	REFUGEE_BACKGROUND_DOCTOR,
	REFUGEE_BACKGROUND_HUNTER,
	REFUGEE_BACKGROUND_LUMBERJACK,
	REFUGEE_BACKGROUND_FARMER,
	REFUGEE_BACKGROUND_FISHERMAN,
	REFUGEE_BACKGROUND_NOMAD,
)))
